...
const EnhancedTableToolbar = ({ numSelected, handleSearch, search, placeholder }) => {
  return (
    <Toolbar
      sx={{
        pl: { sm: 2 },
...
const ListTable = ({
  ...
  useEffect(() => {
    ...
    setPage(0); // reset pagination whenever rows change
  ...
  const handleEditCategory = (id) => {
    navigate(`/dashboard/badge/edit/${id}`);
  };
                      ...
                      >
                        ...
                        {isBrandsList ? (
                          <>
                            ...
                            <TableCell>
                              <Typography>{row?.backgroundColor || 'No Background'}</Typography>
                            </TableCell>
                            <TableCell>
                              <Typography>{row?.text || 'No Text'}</Typography>
                            </TableCell>
                            <TableCell>
                              <Typography>
